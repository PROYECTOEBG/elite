...
try {
if (options.fromCommand) m?.chat ? await conn.sendMessage(m.chat, {text : '*🟢 SESIÓN PENDIENTE*\n\n> *INTENTÉ MANUALMENTE VOLVER A SER SUB-BOT, USANDO EL COMANDOS:* /jadibot' }, { quoted: m }) : ""
} catch (error) {
